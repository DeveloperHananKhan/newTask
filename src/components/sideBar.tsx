...
const {isOpen,setIsOpen}= useLogOutModal()
  ...
  return (
    <>
      <div className="h-screen hidden shadow-[4px_0_8px_rgba(0,0,0,0.1)] w-[210px] md:flex flex-col justify-between m-0 md:block lg:flex flex-col justify-between p-4 lg:block">
        <div>
        ...
        <div className="flex flex-col justify-between">
          ...
          <div className=" flex gap-4 items-center">
            <h1 className="text-[15px] text-gray-900 md:text-md">EH</h1>
            <div className="flex flex-col">
              <p className="mt-4 text-[12px] md:text-md">EVE</p>
